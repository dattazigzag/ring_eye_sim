...
// totalLEDStrips, stripPins[] and stripsEnabled[] now live in config.h (single source of truth).
...
Adafruit_NeoPixel strips[totalLEDStrips] = {
    Adafruit_NeoPixel(numLeds, stripPins[0], STRIP_COLOR_ORDER + NEO_KHZ800),
    Adafruit_NeoPixel(numLeds, stripPins[1], STRIP_COLOR_ORDER + NEO_KHZ800),
    Adafruit_NeoPixel(numLeds, stripPins[2], STRIP_COLOR_ORDER + NEO_KHZ800),
    Adafruit_NeoPixel(numLeds, stripPins[3], STRIP_COLOR_ORDER + NEO_KHZ800),
};
